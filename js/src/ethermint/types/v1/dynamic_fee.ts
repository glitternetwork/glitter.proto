...
export const ExtensionOptionDynamicFeeTx = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ExtensionOptionDynamicFeeTx {
    ...
    const message = { ...baseExtensionOptionDynamicFeeTx } as ExtensionOptionDynamicFeeTx;
  ...
  fromJSON(object: any): ExtensionOptionDynamicFeeTx {
    const message = { ...baseExtensionOptionDynamicFeeTx } as ExtensionOptionDynamicFeeTx;
    if (object.maxPriorityPrice !== undefined && object.maxPriorityPrice !== null) {
      message.maxPriorityPrice = String(object.maxPriorityPrice);
    } else {
