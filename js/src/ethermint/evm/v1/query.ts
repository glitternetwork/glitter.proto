...
const baseQueryTraceTxRequest: object = { blockNumber: Long.ZERO, blockHash: "" };
...
export interface Query {
  ...
  TraceBlock(
    request: DeepPartial<QueryTraceBlockRequest>,
    metadata?: grpc.Metadata,
...
export class QueryClientImpl implements Query {
  ...
  CosmosAccount(
    ...
    return this.rpc.unary(QueryCosmosAccountDesc, QueryCosmosAccountRequest.fromPartial(request), metadata);
  }
  ...
  Storage(
    ...
    return this.rpc.unary(QueryStorageDesc, QueryStorageRequest.fromPartial(request), metadata);
  }
  ...
  EthCall(request: DeepPartial<EthCallRequest>, metadata?: grpc.Metadata): Promise<MsgEthereumTxResponse> {
    return this.rpc.unary(QueryEthCallDesc, EthCallRequest.fromPartial(request), metadata);
  }

  EstimateGas(request: DeepPartial<EthCallRequest>, metadata?: grpc.Metadata): Promise<EstimateGasResponse> {
    return this.rpc.unary(QueryEstimateGasDesc, EthCallRequest.fromPartial(request), metadata);
  }

  TraceTx(
    request: DeepPartial<QueryTraceTxRequest>,
    metadata?: grpc.Metadata,
  ): Promise<QueryTraceTxResponse> {
    return this.rpc.unary(QueryTraceTxDesc, QueryTraceTxRequest.fromPartial(request), metadata);
  }
  ...
  TraceBlock(
    ...
    return this.rpc.unary(QueryTraceBlockDesc, QueryTraceBlockRequest.fromPartial(request), metadata);
  }
...
export const QueryTraceTxDesc: UnaryMethodDefinitionish = {
  methodName: "TraceTx",
  service: QueryDesc,
  requestStream: false,
  responseStream: false,
  requestType: {
    serializeBinary() {
      return QueryTraceTxRequest.encode(this).finish();
    },
  } as any,
  responseType: {
    deserializeBinary(data: Uint8Array) {
      return {
        ...QueryTraceTxResponse.decode(data),
        toObject() {
          return this;
        },
      };
...
export const QueryTraceBlockDesc: UnaryMethodDefinitionish = {
  ...
  requestType: {
    serializeBinary() {
      return QueryTraceBlockRequest.encode(this).finish();
    },
  } as any,
  responseType: {
    deserializeBinary(data: Uint8Array) {
      return {
        ...QueryTraceBlockResponse.decode(data),
        toObject() {
          return this;
        },
      };
