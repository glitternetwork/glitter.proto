...
type QueryEvidenceResponse struct {
	...
	Evidence *any1.Any `protobuf:"bytes,1,opt,name=evidence,proto3" json:"evidence,omitempty"`
}
...
func (x *QueryEvidenceResponse) GetEvidence() *any1.Any {
	if x != nil {
		return x.Evidence
	}
	return nil
...
type QueryAllEvidenceResponse struct {
	...
	Evidence []*any1.Any `protobuf:"bytes,1,rep,name=evidence,proto3" json:"evidence,omitempty"`
...
func (x *QueryAllEvidenceResponse) GetEvidence() []*any1.Any {
	if x != nil {
		return x.Evidence
	}
	return nil
...
var file_cosmos_evidence_v1beta1_query_proto_rawDesc = []byte{
	...
	0x69, 0x64, 0x65, 0x6e, 0x63, 0x65, 0x2f, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2f, 0x65,
	0x76, 0x69, 0x64, 0x65, 0x6e, 0x63, 0x65, 0x42, 0x2f, 0x5a, 0x2d, 0x67, 0x69, 0x74, 0x68, 0x75,
	0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2f, 0x63, 0x6f, 0x73,
	0x6d, 0x6f, 0x73, 0x2d, 0x73, 0x64, 0x6b, 0x2f, 0x78, 0x2f, 0x65, 0x76, 0x69, 0x64, 0x65, 0x6e,
