...
type TxBody struct {
	...
	ExtensionOptions []*any1.Any `protobuf:"bytes,1023,rep,name=extension_options,json=extensionOptions,proto3" json:"extension_options,omitempty"`
	// extension_options are arbitrary options that can be added by chains
	// when the default options are not sufficient. If any of these are present
	// and can't be handled, they will be ignored
	NonCriticalExtensionOptions []*any1.Any `protobuf:"bytes,2047,rep,name=non_critical_extension_options,json=nonCriticalExtensionOptions,proto3" json:"non_critical_extension_options,omitempty"`
}
...
func (x *TxBody) GetMessages() []*any1.Any {
	if x != nil {
		return x.Messages
	}
	return nil
...
func (x *TxBody) GetExtensionOptions() []*any1.Any {
	if x != nil {
...
func (x *TxBody) GetNonCriticalExtensionOptions() []*any1.Any {
	if x != nil {
...
func (x *SignerInfo) GetPublicKey() *any1.Any {
	if x != nil {
		return x.PublicKey
	}
	return nil
...
func (*ModeInfo_Single) Descriptor() ([]byte, []int) {
	return file_cosmos_tx_v1beta1_tx_proto_rawDescGZIP(), []int{6, 0}
}
...
func (*ModeInfo_Multi) Descriptor() ([]byte, []int) {
	return file_cosmos_tx_v1beta1_tx_proto_rawDescGZIP(), []int{6, 1}
}
...
var file_cosmos_tx_v1beta1_tx_proto_rawDesc = []byte{
	...
	0x6e, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x8d, 0x01, 0x0a, 0x02, 0x54, 0x78, 0x12,
	...
	0x31, 0x2e, 0x54, 0x78, 0x42, 0x6f, 0x64, 0x79, 0x52, 0x04, 0x62, 0x6f, 0x64, 0x79, 0x12, 0x38,
	...
	0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x41, 0x75, 0x74, 0x68, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x08,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0x76, 0x0a, 0x08, 0x41, 0x75, 0x74, 0x68, 0x49, 0x6e, 0x66,
	...
	0x65, 0x74, 0x61, 0x31, 0x2e, 0x46, 0x65, 0x65, 0x52, 0x03, 0x66, 0x65, 0x65, 0x22, 0x97, 0x01,
	...
	0x66, 0x6f, 0x73, 0x42, 0x05, 0x0a, 0x03, 0x73, 0x75, 0x6d, 0x22, 0xb7, 0x01, 0x0a, 0x03, 0x46,
	0x65, 0x65, 0x12, 0x63, 0x0a, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x01, 0x20, 0x03,
	...
	0x69, 0x6d, 0x69, 0x74, 0x12, 0x14, 0x0a, 0x05, 0x70, 0x61, 0x79, 0x65, 0x72, 0x18, 0x03, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x05, 0x70, 0x61, 0x79, 0x65, 0x72, 0x12, 0x18, 0x0a, 0x07, 0x67, 0x72,
	0x61, 0x6e, 0x74, 0x65, 0x72, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x67, 0x72, 0x61,
	0x6e, 0x74, 0x65, 0x72, 0x42, 0x27, 0x5a, 0x25, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63,
...
var file_cosmos_tx_v1beta1_tx_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_cosmos_tx_v1beta1_tx_proto_goTypes = []interface{}{
	...
	(*TxBody)(nil),                 // 3: cosmos.tx.v1beta1.TxBody
	(*AuthInfo)(nil),               // 4: cosmos.tx.v1beta1.AuthInfo
	(*SignerInfo)(nil),             // 5: cosmos.tx.v1beta1.SignerInfo
	(*ModeInfo)(nil),               // 6: cosmos.tx.v1beta1.ModeInfo
	(*Fee)(nil),                    // 7: cosmos.tx.v1beta1.Fee
	(*ModeInfo_Single)(nil),        // 8: cosmos.tx.v1beta1.ModeInfo.Single
	(*ModeInfo_Multi)(nil),         // 9: cosmos.tx.v1beta1.ModeInfo.Multi
	(*any1.Any)(nil),               // 10: google.protobuf.Any
	(*types.Coin)(nil),             // 11: cosmos.base.v1beta1.Coin
	(signing.SignMode)(0),          // 12: cosmos.tx.signing.v1beta1.SignMode
	(*types1.CompactBitArray)(nil), // 13: cosmos.crypto.multisig.v1beta1.CompactBitArray
}
var file_cosmos_tx_v1beta1_tx_proto_depIdxs = []int32{
	3,  // 0: cosmos.tx.v1beta1.Tx.body:type_name -> cosmos.tx.v1beta1.TxBody
	4,  // 1: cosmos.tx.v1beta1.Tx.auth_info:type_name -> cosmos.tx.v1beta1.AuthInfo
	10, // 2: cosmos.tx.v1beta1.TxBody.messages:type_name -> google.protobuf.Any
	10, // 3: cosmos.tx.v1beta1.TxBody.extension_options:type_name -> google.protobuf.Any
	10, // 4: cosmos.tx.v1beta1.TxBody.non_critical_extension_options:type_name -> google.protobuf.Any
	5,  // 5: cosmos.tx.v1beta1.AuthInfo.signer_infos:type_name -> cosmos.tx.v1beta1.SignerInfo
	7,  // 6: cosmos.tx.v1beta1.AuthInfo.fee:type_name -> cosmos.tx.v1beta1.Fee
	10, // 7: cosmos.tx.v1beta1.SignerInfo.public_key:type_name -> google.protobuf.Any
	6,  // 8: cosmos.tx.v1beta1.SignerInfo.mode_info:type_name -> cosmos.tx.v1beta1.ModeInfo
	8,  // 9: cosmos.tx.v1beta1.ModeInfo.single:type_name -> cosmos.tx.v1beta1.ModeInfo.Single
	9,  // 10: cosmos.tx.v1beta1.ModeInfo.multi:type_name -> cosmos.tx.v1beta1.ModeInfo.Multi
	11, // 11: cosmos.tx.v1beta1.Fee.amount:type_name -> cosmos.base.v1beta1.Coin
	12, // 12: cosmos.tx.v1beta1.ModeInfo.Single.mode:type_name -> cosmos.tx.signing.v1beta1.SignMode
	13, // 13: cosmos.tx.v1beta1.ModeInfo.Multi.bitarray:type_name -> cosmos.crypto.multisig.v1beta1.CompactBitArray
	6,  // 14: cosmos.tx.v1beta1.ModeInfo.Multi.mode_infos:type_name -> cosmos.tx.v1beta1.ModeInfo
...
func file_cosmos_tx_v1beta1_tx_proto_init() {
	...
	file_cosmos_tx_v1beta1_tx_proto_msgTypes[6].OneofWrappers = []interface{}{
